...
#define AI_NETWORK_FILE_NAME    "network_rel.bin"   // the AI network reloc bin file name
#define AI_WEIGHTS_FILE_NAME    "network_data.bin"  // the AI weights reloc bin file name
#endif

#ifdef  MODULE_LOAD_FROM_FILE  
#define MODULE_FILE_NAME       "Module.bin"   // the TreadX module bin file name
#endif
/* USER CODE END EM */
...
#define MODULE_MANAGER_THREAD_PRIO                         (10)
#define MODULE_MANAGER_THREAD_PREEMPTION_THRESHOLD         (MODULE_MANAGER_THREAD_PRIO)

#define AI_APP_MEM_POOL_SIZE                               (10*1024)
#define AI_THREAD_PRIO                                     (10)
#define AI_THREAD_PREEMPTION_THRESHOLD                     (AI_THREAD_PRIO)
